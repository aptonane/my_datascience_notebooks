...
# Contents:
# 1) House Sales in King County, USA  - Regularization and Selecting Models: https://github.com/aptonane/my_notebooks/blob/master/House_Sales_Lasso_Ridge.ipynb
...
# 2) Lending Club Unbalanced Dataset - Resampling Techniques: https://github.com/aptonane/my_notebooks/blob/master/Lending_Club_Unbalanced_Resam_Tech.ipynb
...
# 3) Medical Appointment No Shows: Why do 30% of patients miss their scheduled appointments? https://github.com/aptonane/my_notebooks/blob/master/Medical_Appointments_No_Shows.ipynb
...
# 4) Movie Revenue Prediction: What's the best model: Linear, Polynomial, Ridge, Lasso regression:https://github.com/aptonane/my_notebooks/blob/master/Movie_Revenue_Regression_Model.ipynb
...
# 5) Admitted or not?: https://github.com/aptonane/my_notebooks/blob/master/UCL_Dataset_Admitted_or_Not.ipynb
...
# 6) EDA (Exploratory Data Analysis) of Accidents in the Brazilian Federal Highways - (In Portuguese): https://github.com/aptonane/my_notebooks/blob/master/EDA_Acidentes_RF_Brazil.ipynb
...
# 7) NPL: Classifying Most Negative and Positives Reviews: https://github.com/aptonane/my_notebooks/blob/master/NPL_Classifying_Most_Negatives_Positives_Reviews.ipynb
...
# 8) NPL: Top ten "spammiest" words: https://github.com/aptonane/my_notebooks/blob/master/NPL_Top_ten_spammiest_words.ipynb
